...
- **The unifier** captures what happened *after* the purchase.
...
## 2. The unifier — Financial Command Center

`MoneyTalks` (working repo name; **consumer name TBD** per E1).
...
**The unifier = AFTER the transaction + the overall command center.**
...
| The unifier | Apple Pay capture, canonical financial view, cross-product analytics and orchestration |
...
- **Chapter 4 — the unifier:** Apple Pay transaction capture, and the realization
...
The unifier needs a consumer name (E1 supersedes D1, which had set the consumer
brand to PickMe). The replacement is **only** for the unifier — not PickMe,
Looply, or MarketLens.
...
**Open.** Repos keep their working names until it is chosen. D1's CIPO Nice
9/36/42 clearance check transfers to the new name before public launch.
