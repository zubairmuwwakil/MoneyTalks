...
- **Inunity** (the unifier) captures what happened *after* the purchase.
...
## 2. Inunity — Financial Command Center

`MoneyTalks` is the working repo name. Consumer name **Inunity** (`inunity.ca`),
...
**Inunity = AFTER the transaction + the overall command center.**
...
| Inunity | Apple Pay capture, canonical financial view, cross-product analytics and orchestration |
...
- **Chapter 4 — Inunity:** Apple Pay transaction capture, and the realization
...
**RESOLVED 2026-08-18 — the name is Inunity** (`inunity.ca` purchased). E1
...
Inunity before public launch, and has a known obstacle: an unrelated software
